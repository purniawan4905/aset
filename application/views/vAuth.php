    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <!-- <center><img src="../asset/images/logo.png" alt=""></center> -->
                <p class="login-box-msg">Sign in to start your session</p>
<br><center><p>Redevelop by <a href='https://aguspurniawan.my.id/' title='aguspurniawan.my.id' target='_blank'>Agus Purniawan</a></p></center>
