...
class cLaporan extends CI_Controller
{
    ...
    public function cetak_laporan()
    {
        ...
        $pdf->Cell(200, 10, 'Berita Acara Inventarisasi Asset RS', 0, 1, 'L');
        $pdf->SetFont('Times', '', 12);
        $pdf->Cell(200, 10, 'Nomor : ', 0, 1, 'L');
        $pdf->Cell(200, 10, 'Tanggal :' . date('d/m/Y'), 0, 1, 'L');

        $pdf->SetFont('Times', 'B', 13);
        $pdf->Cell(200, 10, 'LAPORAN HASIL INVENTARISASI (LHI) ASSET RS', 0, 1, 'C');
        ...
        $pdf->Cell(150, 7, '1. Futri Nahari', 0, 0, 'R');
        $pdf->Cell(30, 7, '............................', 0, 1, 'R');

        $pdf->Cell(150, 7, '2. Narulita Budi S', 0, 0, 'R');
        $pdf->Cell(30, 7, '............................', 0, 1, 'R');
        $pdf->Cell(150, 7, '3. Fahmi', 0, 0, 'R');
        $pdf->Cell(30, 7, '............................', 0, 1, 'R');
        $pdf->Cell(150, 7, '4. Andreas', 0, 0, 'R');
        $pdf->Cell(30, 7, '............................', 0, 1, 'R');
        $pdf->Cell(150, 7, '5. Himmam', 0, 0, 'R');
        $pdf->Cell(30, 7, '............................', 0, 1, 'R');
